  ...
  return (
    <InstantPressable
      ...
      <View style={styles.metalButtonFace}>
        <Ionicons color={palette.controlInk} name={icon} size={18} />
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: palette.cardInk, fontSize: 18, fontWeight: '900', letterSpacing: 0.2 },
  sectionCaption: { color: palette.cardMuted, fontSize: 12, lineHeight: 18, marginTop: 6 },
  ...
  tagText: { color: '#FFFFFF', flexShrink: 1, fontSize: 12, fontWeight: '800' },
  choiceChip: {
    alignItems: 'center',
    backgroundColor: palette.control,
    borderColor: palette.cardBorder,
  ...
  choiceChipSelected: { backgroundColor: palette.control, borderColor: palette.red, borderWidth: 2 },
  choiceLamp: { backgroundColor: palette.cardMuted, borderRadius: 4, height: 8, width: 8 },
  choiceLampSelected: {
    backgroundColor: palette.red,
    shadowColor: palette.red,
    shadowOpacity: 1,
